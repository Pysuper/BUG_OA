    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_datatime', models.DateTimeField(blank=True, null=True, verbose_name='开始时间')),
                ('end_datatime', models.DateTimeField(blank=True, null=True, verbose_name='结束时间')),
                ('create_datetime', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('pro_policy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='transac.PricePolicy', verbose_name='价格策略')),
