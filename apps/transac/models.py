...
class PricePolicy(models.Model):
    """收费类型"""
    category_choies = ((1, "免费版"), (2, "收费版"), (3, "其他",))

    # SmallIntegerField 小范围
    category = models.SmallIntegerField(verbose_name="收费类型", choices=category_choies, default=1)
...
class Transacation(models.Model):
    ...
    start_datatime = models.DateTimeField(verbose_name="开始时间", null=True, blank=True)
    end_datatime = models.DateTimeField(verbose_name="结束时间", null=True, blank=True)
